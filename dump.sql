...
CREATE TABLE tasks (
    ...
    priority TINYINT UNSIGNED DEFAULT 1 COMMENT 'TINYINT used for priority levels 1-3',
    PRIMARY KEY (task_id)
) ENGINE=InnoDB;

-- Categories table
CREATE TABLE categories (
    category_id INT UNSIGNED AUTO_INCREMENT COMMENT 'INT used for unique category identifiers',
